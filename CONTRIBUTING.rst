...
Thank you for taking time to contribute to gites!

The following is a set of guidelines for contributing to gites. These are just guidelines, not rules, use your best judgment and feel free to propose changes to this document in a pull request.
...
#. Additional, not always mandatory checks are being performed by `QuantifiedCode <https://www.quantifiedcode.com/app/project/gh:ktrebicki:gites>`_
